...
namespace Client.salestax {
    ...
    public partial class SalesTaxService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapRpcMethodAttribute("", RequestNamespace="http://ws.jbia.org/", ResponseNamespace="http://ws.jbia.org/", Use=System.Web.Services.Description.SoapBindingUse.Literal)]
        ...
        /// <remarks/>
        public void getRateAsync(string arg0) {
            this.getRateAsync(arg0, null);
        }
        
        /// <remarks/>
        public void getRateAsync(string arg0, object userState) {
            ...
            this.InvokeAsync("getRate", new object[] {
                        arg0}, this.getRateOperationCompleted, userState);
        }
