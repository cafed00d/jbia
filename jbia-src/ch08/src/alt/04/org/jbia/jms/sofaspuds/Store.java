...
public class Store implements MessageListener {
  ...
  public void onMessage(Message msg) {
    ...
    /**
   * Charges the video to the customer's credit card account.
   *
   * @param customer
  ...
  private void charge(String customer) {
    ...
    try { 
      ...
      /*
       * Look up the producer object in JNDI, from there get the manager, and
       * then establish a connection to the messaging server:
       */
      ...
      /*
       * Sending a message is as simple as making a method call. The messaging
       * software handles the marshaling of the parameters.
       */
      ...
      try {
        /*
         * It is a good idea to close the connection when you are done with it:
         */
        if (mgr != null) {
          mgr.close();
        }
