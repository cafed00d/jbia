...
namespace Client.salestax {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="SalesTaxBinding", Namespace="http://ws.jbia.org/")]
    public partial class SalesTaxService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public SalesTaxService() {
            this.Url = global::Client.Properties.Settings.Default.Client_salestax_SalesTaxService;
        ...
        [return: System.Xml.Serialization.XmlElementAttribute("getRateResponse", Namespace="http://ws.jbia.org/")]
        public getRateResponse getRate([System.Xml.Serialization.XmlElementAttribute("getRate", Namespace="http://ws.jbia.org/")] getRate getRate1) {
            object[] results = this.Invoke("getRate", new object[] {
                        getRate1});
            return ((getRateResponse)(results[0]));
        }
        
        /// <remarks/>
        public void getRateAsync(getRate getRate1) {
            this.getRateAsync(getRate1, null);
        }
        
        /// <remarks/>
        public void getRateAsync(getRate getRate1, object userState) {
            ...
            this.InvokeAsync("getRate", new object[] {
                        getRate1}, this.getRateOperationCompleted, userState);
        }
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://ws.jbia.org/")]
    ...
    public partial class getRateCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        ...
        /// <remarks/>
        public getRateResponse Result {
            get {
                this.RaiseExceptionIfNecessary();
                return ((getRateResponse)(this.results[0]));
            }
        }
    }
}
